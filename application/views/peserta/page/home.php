					...
					<div class="card nonround" >
					  	...
					  	<div class="card-body">
					  		...
					  		<div class="col-12 col-md-12">
					  			...
					  			<tr>
					  				<td>Bukti Pembayaran</td><td>&emsp; : &emsp;</td><td><a target="_blank" href="<?php echo base_url('public/kompetisi/userdata/buktipembayaran/'); echo $url_buktipembayaran; ?>">Link</a></td>
					  			</tr>
				  				<?php endif ?>
					  			<tr>
